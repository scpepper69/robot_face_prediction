...
//    private val IMAGE_STD = 128.0f
    ...
    private var classArray = arrayOf("RX-178", "MSZ-006", "RX-93", "MS-06", "RX-78-2", "F91")
...
//    fun classifyImageFromPath(path: String): Int {
     fun classifyImageFromPath(bitmap: Bitmap): Pair<String, Float> {
//        val file = File(path)
...
//        val bitmap = BitmapFactory.decodeFile(file.path)
        ...
        return Pair(classArray[onehotToLabel(pred[0])], pred[0][onehotToLabel(pred[0])])
    }
